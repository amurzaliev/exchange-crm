...
Функционал: Тестируем создание редактирование и просмотр обменного пункта
  ...
  Сценарий: Я захожу на сайт как владелец обменных пунктов и редактирую обменный пункт
    ...
    Когда я дополнительно выбираю опцию "Тенге" из поля выбора "exchange_currencies"
    Когда я дополнительно выбираю опцию "Евро" из поля выбора "exchange_currencies"
    Когда я дополнительно выбираю опцию "Петров А.А" из поля выбора "exchange_staffs"
